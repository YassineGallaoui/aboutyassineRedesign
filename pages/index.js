    ...
    <>
      ...
      <div className={styles.meContainer+' col-8 offset-2'}>
        <div className={styles.meContainer__txt}>
          ...
          I have a lot of <span className={styles.meContainer__txt__big}>interests</span> and the majority of them <span className={styles.meContainer__txt__big}>gravitate around IT</span>, going from electronics to digital ethics and from web design to mobile development.<br />
          My focus is always into making <span className={styles.meContainer__txt__big}>software</span> which just not <span className={styles.meContainer__txt__big}>works good</span> but also is <span className={styles.meContainer__txt__big}>aesthetically captivating</span>.
        </div>
      </div>
    </>
  )
