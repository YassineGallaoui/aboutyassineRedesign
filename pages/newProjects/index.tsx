                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className={stylesHome.triangleProjectContent}>
                                        <div
                                            id={`see-more-${index2 % 2 === 1 ? "odd" : "even"}-${projectsDataset[index2 - firstPositionProject]?.id
                                                }`}
                                ...
                                if (
                                    ...
                                    return (
                                        <div
                                            ...
                                            id={`triangleProjectWrapper-${projectsDataset[index2 - firstPositionProject]?.id
                                                }`}
                                        >
                                            <div
                                                className={
                                                ...
                                                id={`triangleProjectContent-${projectsDataset[index2 - firstPositionProject]?.id
                                                    }`}
                                                data-project-id={
                                            ...
                                            >
                                                <Image
                                                    ...
                                                    priority={true}
                                                    id={`image-${projectsDataset[index2 - firstPositionProject]?.id
                                                        }`}
                                                    className={"image"}
                                                    quality={100}
                                                    fill={true}
                                                    sizes="70dvw"
                                                    alt={`Project ${projectsDataset[index2 - firstPositionProject]?.name
                                                        }`}
                                                    onMouseOver={() =>
                                                        handleImageHover(
                                                            projectsDataset[index2 - firstPositionProject]?.id
